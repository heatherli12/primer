...
<!-- Cut out all R and R Studio section. Place cool/useful parts of it in Getting Started. DONE -->
...
<!-- Add the formula for median, like this one: https://math.stackexchange.com/questions/1097546/what-is-the-general-formula-for-calculating-the-median. DONE -->
...
hundred_days_p <- president_data %>%
  ggplot(mapping = aes(x = enddate,
   ...
   labs(title = "Approval Ratings During the First Hundred Days",
        subtitle = "Both recent presidents have climbing disapproval ratings during their first hundred days.",
        x = NULL,
        y = NULL,
        color = NULL,
