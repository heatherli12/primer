...
<!-- Do the census and maps tutorials from chapter 3. Consider https://walker-data.com/census-r/ -->
...
asian_pop <- get_acs(geography = "state",
                     variables = c("B01003_001","B02001_005"),
                     year = 2018,
                     output = "wide",
                     geometry = TRUE) %>% 
               shift_geometry()
...
map_p <- asian_pop %>% 
  ggplot(mapping = aes(fill = (B02001_005E/B01003_001E) * 100)) + 
    geom_sf()
