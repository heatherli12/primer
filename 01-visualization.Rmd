...
trump_data <- read_csv("01-visualization/data/approval_polllist_trump.csv",
                       show_col_types = FALSE)

biden_data <- read_csv("01-visualization/data/approval_polllist_trump.csv",
                       show_col_types = FALSE)
...
trump_p <- trump_data %>% 
  ggplot(mapping = aes(x = enddate,
   ...
   labs(title = "Presidential First Term Approval Ratings",
        x = NULL,
        y = NULL,
        color = NULL,
